...
const PricingCard = ({
    ...
    const handlePopup = async () => {
        ...
        try {
            if (clerk && clerk.__internal_openCheckout) {
                await clerk.__internal_openCheckout({
                    planId: planId,
                    planPeriod: "month",
                    subscriberType: "user",
                });
            } else {
                console.error("Clerk billing is not initialized or clerk instance is missing.");
            }
        } catch (error) {
...
const PricingSection = () => {
    const plans = [
        ...
        },
        {
            ...
            featured: true,
            planId: "cplan_3CDIVVBFmtNAgE1uCOs3Z8qDQXo",
